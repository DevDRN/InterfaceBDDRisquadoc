...
<header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
  <div class="col-md-3 mb-2 mb-md-0">
    <a href="dashboard.php" class="d-inline-flex link-body-emphasis text-decoration-none" title="Retour au menu">
      <img src="../img/GILtransparent.svg" alt="GIL" class="logo">
<!--       <svg class="logo" aria-label="GIL">
        <use xlink:href="../img/GILtransparent.svg"></use>
      </svg>
 -->    </a>
  </div>
  ...
  <div class="container text-center">
    <header class="d-flex justify-content-center py-3 row align-items-start">
      ...
      <!-- <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a href="#" class="nav-link">Gestion utilisateurs</a></li>
      </ul> -->
    </header>
  </div>
