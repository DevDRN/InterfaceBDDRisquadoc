...
$sqlSel = "SELECT * FROM CORRESPONDANTS WHERE CODE_CORRESP = :id";
...
if ($_SERVER['REQUEST_METHOD'] !== 'POST' || isset($_POST['delete'])) {
    ...
    $telFixe = $row['TEL_FIXE_CORRESP'];
    $email = $row['MAIL_CORRESP'];
}
?>
...
<head>
  ...
  <title>InterfaceBDDRisquadoc Modification correspondants</title>
  ...
  <script type="text/javascript">
    ...
    function confirmDeletion() {
        return confirm("Êtes-vous sûr de vouloir supprimer ce correspondant ? Cette action est irréversible.");
    }
    </script>
</head>
